            ...
            <form action="../process/register-user.php" method="POST" class="p-4"
                ...
                <fieldset class="p-5">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" id="email" name="email" class="form-control" onkeypress="clearErrorMessage('email_error')"/>
                         <div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" id="qualification_bachelor" name="qualification[]" value="bachelor">
                        Bachelor
